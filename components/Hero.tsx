  ...
  const handleSubmit = async () => {
    try {
      ...
      const { error } = await supabase
        .from("calhacks-12.0-interest-form")
        .insert({ email });
      if (error) {
      ...
      <div className="flex flex-col md:flex-row items-center justify-between gap-12">
        ...
        <div className="w-full md:w-1/2 text-center md:text-left">
          ...
          <p className="text-lg mb-8 leading-6 text-gray-600 dark:text-gray-300">
            Hackathons @ Berkeley is a team of students cultivating a platform
            where people can build, learn, and experiment without boundaries. We
            host Cal Hacks, our flagship hackathon, alongside other hackathons
            every year!
          </p>
          <p className="text-lg mb-8 leading-6 text-gray-600 dark:text-gray-300">
