            ...
            <div className="flex flex-col md:flex-row items-center gap-12">
              ...
              <div className="w-full md:w-1/2">
                ...
                <p className="text-lg mb-4 text-gray-700 dark:text-gray-300">
                  We&apos;re a nonprofit organization composed of students
                  passionate about fostering a culture of hacking,
                  entrepreneurship, and social good via the empowerment of
                  technology.
                </p>
                <p className="text-lg text-gray-700 dark:text-gray-300">
                  Our mission is to empower others with technology to create
        ...
        <section className="py-20 px-6">
          <div className="flex flex-col items-center max-w-7xl mx-auto">
            ...
            <p className="text-lg text-center mb-12 dark:text-white">
              ...
              internships and full-time employment across a variety of
              industries.
            </p>
